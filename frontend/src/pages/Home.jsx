        ...
        <div className="max-w-7xl mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-[#00b8a3] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#00a693] transition-colors" onClick={goToProblem}>
                Start Learning
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {dsaTopics.map((topic, index) => (
              <div key={index} className="bg-[#1a1a1a] rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-[#3a3a3a] hover:border-[#00b8a3]">
                <div className={` w-16 h-16 rounded-lg flex items-center justify-center text-white mb-4`}>
                  {topic.icon}
                </div>
