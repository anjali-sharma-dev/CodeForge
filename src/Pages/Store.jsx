                ...
                <div key={course.id} className="bg-[#1a1a1a] rounded-xl border border-[#3a3a3a] hover:border-[#666666] transition-colors duration-300 overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <button
                        ...
                        className={`p-2 rounded-full transition-colors ${
                          course.isWishlisted 
                            ? 'text-[#ff375f] bg-[#ff375f] bg-opacity-10' 
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                      {course.isBestSeller && (
                        <span className="text-xs bg-[#ff8c00] bg-opacity-20 text-[#ff8c00] px-2 py-1 rounded-full font-medium">
                          Best Seller
                        </span>
                      )}
                      <span className={`text-xs px-2 py-1 rounded-full font-medium ${
                        course.level === 'Beginner' ? 'bg-[#00b8a3] bg-opacity-20 text-[#00b8a3]' :
                        course.level === 'Intermediate' ? 'bg-[#ffc01e] bg-opacity-20 text-[#ffc01e]' :
                        'bg-[#ff375f] bg-opacity-20 text-[#ff375f]'
                      }`}>
                        {course.level}
                      </span>
                    </div>
